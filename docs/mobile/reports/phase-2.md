...
| `npm run test:unit` | PASS，72/72；包含 canonical workspace page/query guard、loaded/native resolver fallback、partial bootstrap metrics，以及 iOS first-paint/Android native-schedule delivery mode 回归 |
